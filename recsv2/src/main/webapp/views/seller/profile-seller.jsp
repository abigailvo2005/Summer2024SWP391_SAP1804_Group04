                  ...
                  <div class="card-body p-3">
                    <ul class="list-group">
                      ...
                      <li class="list-group-item border-0 d-flex align-items-center px-0 mb-2">
                        <div class="navbar-toggler-icon d-flex justify-content-center my-1 mx-2">
                      ...
                      <div id="phoneModal" class="profileUpdate">
                        <div class="update-content">
                          <span class="close-update" id="closePhone">&times;</span>
                          <h5>Update Phone Number</h5>
                          <form id="phoneForm">
                            <h6 for="phone">New Phone Number:</h6>
                            <input type="number" id="phone" name="phone" class="form-control"
                              placeholder="Enter new phone number" min="1" required>
                            <div id="phoneError" class="error-message"></div>
                            <button type="submit" id="updatePhone" class="btn btn-dark my-2 mb-2">Update</button>
                            <button type="button" class="btn btn-dark my-2 mb-2" id="cancelPhone">Cancel</button>
                          </form>
                        </div>
                      </div>
                      ...
                      <div id="passwordModal" class="profileUpdate">
                        <div class="update-content">
                          <span class="close-update" id="closePassword">&times;</span>
                          ...
                          <form id="passwordForm">
                            <div>
                              ...
                              <div class="password-container">
                                ...
                                <button type="button" class="toggle-password" data-toggle="#oldPassword">Show</button>
                              </div>
                            ...
                            <div>
                              ...
                              <div class="password-container">
                                ...
                                <button type="button" class="toggle-password" data-toggle="#newPassword">Show</button>
                            ...
                            <div>
                              ...
                              <div class="password-container">
                                ...
                                <button type="button" class="toggle-password"
                                  data-toggle="#confirmPassword">Show</button>
                                <div id="confirmPasswordError" class="error-message">
                                </div>
                              </div>
                            </div>
                            <div class="modal-buttons">
                              <button type="submit" id="updatePassword" class="btn btn-dark my-2 mb-2">Update</button>
                              <button type="button" class="btn btn-dark my-2 mb-2" id="cancelPassword">Cancel</button>
                            </div>
                          </form>
                        </div>
                      </div>
        ...
        updatePasswordBtn.onclick = function (event) {
          ...
          if (passwordForm.checkValidity()) {
            ...
            if (!passwordPattern.test(newPassword.value)) {
              newPasswordError.textContent = "New password must be at least 8 characters long and contain both letters, special letters and numbers.";
              return;
            } else {
              newPasswordError.textContent = "";
            }
