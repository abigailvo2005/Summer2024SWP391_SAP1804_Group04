            ...
            <div class="col-12 col-xl-6 mt-sm-4">
              <div class="card h-100">
                ...
                <div class="card-body p-3">
                  <p class="text-sm">
                    As a seller, you can upload your properties and related
                    ...
                    Eventually, you will be able to connect with and confirm the
                    transaction of selling your properties to an appropriate
                    buyer through RECS.
                  </p>
                  <ul class="list-group">
                  ...
                  <ul class="list-group">
                    ...
                    <div id="phoneModal" class="profileUpdate">
                      <div class="update-content">
                        ...
                        <form action="${pageContext.request.contextPath}/seller/phone/update" method="post" id="phoneForm">
                    ...
                    <div id="passwordModal" class="profileUpdate">
                      <div class="update-content">
                        ...
                        <form action="${pageContext.request.contextPath}/seller/password/update" method="post" id="passwordForm">
                          <div>
