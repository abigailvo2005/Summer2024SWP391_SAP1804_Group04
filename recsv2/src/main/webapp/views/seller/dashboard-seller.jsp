    ...
    <body class="g-sidenav-show bg-gray-100" onload="makeTableScroll()">
                  ...
                  <div class="row">
                    <div class="col-lg-8 col-9">
                      ...
                      <p class="text-sm mb-0">
                        ...
                        <span class="font-weight-bold ms-1">${propList.size()} propertie(s)</span>
                    ...
                    <div class="ms-md-auto pe-md-3 d-flex align-items-center col-lg-4 col-3">
                      <div class="input-group">
                        ...
                        <input id="ownSearch" type="text" class="form-control" placeholder="Type name/type here..."
                          ...
                          <c:forEach items="${propList}" var="prop">
                            <tr class="prop-row">
                              <td>
                                <div class="d-flex justify-content-start">
                                  <div class="d-flex flex-column justify-content-start">
                                    <p id="prop-name" class="mb-0 text-sm fw-bold text-dark">
                                      ${prop.name}
                                    </p>
                                  </div>
                                </div>
                              ...
                              <td>
                                <div class="d-flex px-2 py-1 justify-content-center">
                                  <div class="d-flex flex-column justify-content-center">
                                    <p id="prop-price" class="mb-0 text-sm fw-bold text-dark">
                                      ${prop.textPrice}
                                    </p>
                                  </div>
                                </div>
                              ...
                              <td class="align-middle">
                                <div class="d-flex px-2 py-1 justify-content-center">
                                  <div class="d-flex flex-column justify-content-center">
                                    <p id="prop-type" class="mb-0 text-sm fw-bold text-dark">
                                      ${prop.realEstateType}
                                    </p>
                                  </div>
                                </div>
                              ...
                              <td class="align-middle">
                                <div class="d-flex px-2 py-1 justify-content-center">
                                  <div class="d-flex flex-column justify-content-center">
                                    <p id="prop-status" class="mb-0 text-sm fw-bold status-color"
                              ...
                              <td class="align-middle">
                                <div class="d-flex px-2 py-1 justify-content-center">
                                  <div class="d-flex flex-column justify-content-center">
                                    <a class="show-detail"
                                      onclick="viewDetailProperty('${prop.realEstateId}', 'prop')"><i
                ...
                <div class="card-header pb-0">
                  <div class="row">
                    <div class="col-lg-8 col-9">
                      ...
                      <p class="text-sm mb-0">
                        <i class="fa-solid fa-house-user"></i>
                        <span class="font-weight-bold ms-1">${draftList.size()} propertie(s)</span>
                            ...
                            <tr class="draft-row">
                              ...
                              <td class="align-middle">
                                <div class="d-flex px-2 py-1 justify-content-center">
                                  <div class="d-flex flex-column justify-content-center">
                                    <a class="show-detail"
                                      onclick="viewDetailProperty('${draft.realEstateId}', 'draft')"><i
                                        class="fa-solid fa-eye"></i></a>
                                  </div>
                                </div>
                              </td>
                    ...
                    <div class="container-fluid">
                      ...
                      <div class="row land-info-section hidden">
                        ...
                        <li class="list-group-item border-0 ps-0 text-sm col-6 d-flex">
                          ...
                          <form action="
                          ${pageContext.request.contextPath}/seller/dashboard" method="post" class="hidden change ms-2"
                            id="form-change-land-pw">
                            <input name="realEstateID" id="popup-id" class="hidden" />
                            <input id="prop-pw-land" type="file" accept="application/pdf, application/zip"
                              class="form-control form-create-control" required />
                            <button id="submit-land-btn" class="btn btn-padding mt-2" type="button">
                              Change
                            </button>
                            <button class="btn btn-padding ms-2 mt-2" onclick="hideChangePW('land')">
                              Cancel
                            </button>
                            <input class="hidden" id="land-pw-container" name="url" type="text" />
                          </form>
                      ...
                      <div class="house-info-section hidden">
                        <div class="row">
                          ...
                          ${pageContext.request.contextPath}/seller/dashboard" method="post" class="hidden change ms-2"
                              ...
                              <input name="realEstateID" id="popup-id" class="hidden" />
                              <input id="prop-pw-house" type="file" accept="application/pdf, application/zip"
                                class="form-control form-create-control" required />
                              <button id="submit-house-btn" class="btn btn-padding mt-2" type="button">
                                Change
                              </button>
                              <button class="btn btn-padding ms-2 mt-2" onclick="hideChangePW('house')">
                                Cancel
                              </button>
                              <input class="hidden" id="house-pw-container" name="url" type="text" />
                            </form>
                      ...
                      <div id="draft-section" class="row d-flex justify-content-center hidden">
                        <form class="col-4" action="${pageContext.request.contextPath}/seller/real-estate/request"
                          id="request-validation" method="get">
                          <input type="hidden" id="request-reId" name="realEstateId" />
                          <button id="request-validate-btn" class="btn btn-dark me-3 col-12"
                            onclick="draftLoadId(event, this.value, '#request-reId', '#request-validation')">
                            Request Validation
                          </button>
                        </form>

                        <form class="col-4" action="${pageContext.request.contextPath}/seller/real-estate/delete"
                          id="request-delete">
                          <input type="hidden" id="delete-reId" name="realEstateId" />
                          <button id="delete-real-estate-btn" class="btn btn-danger col-12"
                      ...
                      <div id="show-agency-permission" class="d-flex justify-content-center hidden">
                      ...
                      <div id="agency-list" class="row hidden">
                        ...
                        <div class="row">
                          <form id="agency-form"
                            action=" ${pageContext.request.contextPath}/seller/agency-request/approve" method="post">
                            <input id="realEstateId" name="realEstateId" type="hidden" />
                            <div id="selected-agency-container" class="hidden"></div>
                            <div class="d-flex justify-content-end">
                              <button type="submit" class="btn btn-secondary confirm-agency"
                      ...
                      <div id="show-buyer-permission" class="d-flex justify-content-center hidden">
                      ...
                      <div id="buyer-list" class="row hidden">
                        ...
                        <div class="row">
                          <form id="buyer-form"
                            action=" ${pageContext.request.contextPath}/seller/buyer-request/approve" method="post">
                            <div id="selected-buyer-container" class="hidden"></div>
                            <div class="d-flex justify-content-end">
                              <button type="submit" class="btn btn-secondary confirm-buyer"
                      ...
                      <div id="confirm-sold-buyer" class="row hidden">
                        ...
                        <form id="form-confirm-sold"
                          action="${pageContext.request.contextPath}/seller/buyer-request/connect" method="post">
                          <li class="row list-group-item border-0 ps-0 text-sm d-flex">
                            <strong class="text-dark col-5">Choose successfully connected Buyer:</strong>
                            <div class="col-5">
                              <select class="form-control form-create-control" id="chosen-buyer-container"
                            ...
                            <input id="chosen-buyer" type="hidden" name="requestId" />

                            <div class="col-2">
                              <button type="button" class="btn bg-gradient-dark w-100" onclick="confirmSold(event)">
                                Submit
                              </button>
                            </div>
                          </li>
      ...
      <div id="popup-message" class="popup-container hidden z-index-3">
        <div id="popup-message-content" class="popup-content container">
          ...
          <div class="popup-header row mx-1">
            <div class="col-11">
              <h4 id="small-popup-header" class="card-header font-weight-bolder mb-0"></h4>
            </div>
            <div class="col-1">
              <i class="fa-solid fa-xmark close-button" onclick="closeDetail('popup-message')"></i>
            </div>
          </div>
      ...
      <script>
        ...
        function confirmAgency(e) {
          ...
          if (!hasChecked) {
            Swal.fire({
              title: 'Warning',
              text: 'Please select at least one agency before submitting.',
              icon: 'warning',
        ...
        function confirmBuyer(e) {
          ...
          if(!hasChecked) {
            Swal.fire({
              title: 'Warning',
              text: 'Please select at least one buyer before submitting.',
              icon: 'warning',
              confirmButtonText: 'OK'
            });
          } else {
        ...
        function confirmSold(event) {
          ...
          if (form.value == "") {
            Swal.fire("No buyer has been chosen.");
            return;
          }

          //show success message
          Swal.fire("Congratulations! You have successfully sold this property. The property will be automatically hidden from the system.");
