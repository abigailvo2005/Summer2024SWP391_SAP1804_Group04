...
<html lang="en">
  ...
  <body class="g-sidenav-show bg-gray-100" onload="makeTableScroll()">
                    ...
                    >
                      ...
                      >
                        ...
                        <button
                          ...
                          class="btn btn-danger me-3 col-12"
                          onclick="deleteLoadId(event, this.value, '#cancel-deal-reId', '#cancel-deal-form')"
                        >
                          Cancel Deal
                        </button>
                      </form>
    ...
    <script>
        ...
        if (type == "listing") {
          ...
          $.ajax({
            ...
            success: function (data) {
              ...
              $("#popup-price").text(data.realEstate.textPrice + " VND");
              $("#popup-agency-message").html(
                data.realEstate.agencyRequests.message
              );
              ...
              //load real estate ID for cancel deal/drop listing
              $("#cancel-deal-btn").val(data.realEstate.realEstateId);
      ...
      //load Real estate ID for deleting (cancel deal/drop listing)
