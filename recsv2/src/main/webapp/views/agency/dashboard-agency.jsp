                  ...
                  <div class="row">
                    <div class="col-lg-8 col-9">
                      ...
                      <p class="text-sm mb-0">
                        ...
                        <span class="font-weight-bold ms-1">${handleList.size()} request(s)</span>
                        in total
                      </p>
                    </div>
                    <div class="ms-md-auto pe-md-3 d-flex align-items-center col-lg-4 col-3">
                      <div class="input-group">
                        ...
                        <input id="ownSearch" type="text" class="form-control" placeholder="Type id/name/type here..."
                          ...
                          <c:forEach items="${handleList}" var="listing">
                            <tr class="listing-row">
                              ...
                              <td>
                                <div class="d-flex px-2 py-1 justify-content-center">
                                  <div class="d-flex flex-column justify-content-center">
                                    <p id="listing-price" class="mb-0 text-sm fw-bold text-dark">
                              ...
                              <td class="align-middle">
                                <div class="d-flex px-2 py-1 justify-content-center">
                                  <div class="d-flex flex-column justify-content-center">
                                    <a class="show-detail" onclick="viewDetail('${listing.requestId}', 'listing')"><i
                ...
                <div class="card-header pb-0">
                  <div class="row">
                    <div class="col-lg-8 col-9">
                      ...
                      <p class="text-sm mb-0">
                        <i class="fa-solid fa-house-user"></i>
                        <span class="font-weight-bold ms-1">${dealList.size()} assignment(s)</span>
                        in total
                      </p>
                    </div>
                    <div class="ms-md-auto pe-md-3 d-flex align-items-center col-lg-4 col-3">
                      <div class="input-group">
                        <span class="input-group-text text-body"><i class="fas fa-search" aria-hidden="true"></i></span>
                        <input id="propSearch" type="text" class="form-control" placeholder="Type id/name/type here..."
                          ...
                          <c:forEach items="${dealList}" var="deal">
                            <tr class="req-row">
                              ...
                              <td class="align-middle">
                                <div class="d-flex px-2 py-1 justify-content-center">
                                  <div class="d-flex flex-column justify-content-center">
                                    <p id="req-status" class="mb-0 text-sm fw-bold status-color" value="${deal.status}">
                                      ${deal.status}
                                    </p>
                                  </div>
                                </div>
                              ...
                              <td class="align-middle">
                                <div class="d-flex px-2 py-1 justify-content-center">
                                  <div class="d-flex flex-column justify-content-center">
                                    <a class="show-detail" onclick="viewDetail('${deal.dealId}', 'deal')"><i
                                        class="fa-solid fa-eye"></i></a>
                                  </div>
                                </div>
                              </td>
