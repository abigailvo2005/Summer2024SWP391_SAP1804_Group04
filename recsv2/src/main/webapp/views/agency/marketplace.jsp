                ...
                <div class="row">
                  <c:forEach items="${propList}" var="prop">
                    <div class="col-md-6 mb-4">
                      <a onclick="viewDetailProperty('${prop.realEstateId}', 'view')" class="card-property-link">
                        <div class="card card-property card-property-hover">
                          <div class="row no-gutters">
                            <div class="col-4">
                              <img src="${prop.propertyImagesList.get(0)}" class="card-img" alt="${prop.name}" />
                            </div>
                            <div class="col-8">
                    ...
                    <div class="container-fluid">
                      <div class="row">
                        <div class="col-5" id="img-section">
                          <!-- image carousel -->
                          <div id="image-section" class="carousel slide mb-3" data-bs-ride="carousel">
                        ...
                        <div class="col-6 ms-4" id="info-section">
                          ...
                          <div id="handle-listing-btn" class="row justify-content-end mt-3">
                            <button class="btn btn-outline-dark" onclick="showAgencyForm()">
                              Handle Listing
                            </button>
                          </div>
                        </div>
                      ...
                      <div class="row">
                        <form id="agency-profile-form" action="${pageContext.request.contextPath}/agency/agency-request"
                          ...
                          <input type="hidden" id="realEstateId" name="realEstateId" />
                          <div class="row mb-3">
                            <div class="col-6">
                              <label for="agency-name" class="form-label">Agency Name: ${name}</label>
                            </div>
                            <div class="col-6">
                              <label for="agency-company" class="form-label">Company: ${agency.company}</label>
                            </div>
                          </div>

                          <div class="row mb-3">
                            <div class="col-6">
                              <label for="agency-phone" class="form-label">Phone Number: ${agency.phone}</label>
                            </div>
                            <div class="col-6">
                              <label for="agency-email" class="form-label">Email: ${agency.email}</label>
                            </div>
                          </div>

                          <div class="row mb-3">
                            <div class="col-6">
                              <label for="agency-name" class="form-label">Experienced Years:
                                ${agency.agencyYearsOfExperience} years</label>
                            </div>
                            <div class="col-6">
                              <label for="agency-contact" class="form-label">Completed Projects:
                                ${agency.completedProject} successfully connected properties.</label>
                            </div>
                          </div>
                          <div class="row mb-3">
                            <div class="col-12">
                              <label for="agency-name" class="form-label">Description/Message to Seller</label>
                              <textarea class="form-control" id="agency-desc" name="agencyMessage"></textarea>
                            </div>
                          </div>
                          <div class="mb-3 row justify-content-center">
                            <label class="form-label text-center"><i>All details will be sent to the Seller for
                                confirmation of the Listing handling.</i></label>
                          </div>

                          <div class="row justify-content-center">
                            <div class="col-auto">
                              <button type="button" class="btn btn-dark" onclick="submitAgencyProfile()">
                                Submit
                              </button>
