            ...
            <div class="col-12 col-xl-6 mt-sm-4">
              <div class="card h-100">
                ...
                <div class="card-body p-3">
                  <p class="text-sm">
                    As an agency, your primary function is to directly handle
                    and manage the assignment of property listings. You will be
                    able to view the validated listings and work with member
                    agents to find suitable buyers for the properties.
                  </p>
                  <ul class="list-group">
