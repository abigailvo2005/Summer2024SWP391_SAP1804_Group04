    ...
    <body class="g-sidenav-show bg-gray-100" onload="makeTableScroll();">
            ...
            <div class="row mt-lg-n8 mt-md-n8 mt-n7 mt-sm-n9">
              <div class="col-12 col-xl-11 mx-auto">
                <div class="card z-index-0">
                  ...
                  <div class="card-body">
                    <form role="form text-left" name="create-acc-member"
                      action="${pageContext.request.contextPath}/agency/create-acc-mem" method="post" modelAttribute="request">
                      <div class="mb-3 row">
                        <div class="col-sm-2">
              ...
              <div class="card-header pb-0">
                <div class="row">
                  <div class="col-lg-8 col-9">
                    <h6>All Member Created</h6>
                    <p class="text-sm mb-0">
                      <i class="fa-solid fa-house-user"></i>
                      <span class="font-weight-bold ms-1">${memberList.size()} account(s)</span>
                      have created
                    </p>
                  </div>
                      ...
                      <c:forEach items="${memberList}" var="member">
                        <tr class="member-row">
                          <td>
                            <div class="d-flex justify-content-start">
                              <div class="d-flex flex-column justify-content-start">
                                <p id="member-name" class="mb-0 text-sm fw-bold text-dark">
                          ...
                          <td>
                            <div class="d-flex justify-content-start">
                              <div class="d-flex flex-column justify-content-start">
                                <p id="member-uname" class="mb-0 text-sm fw-bold text-dark">
                          ...
                          <td class="align-middle">
                            <div class="d-flex px-2 py-1 justify-content-center">
                              <div class="d-flex flex-column justify-content-center">
                                <a onclick="viewDetail('${member.account.accountId}')"><i
      ...
      <script type="text/javascript">
        ...
        function validateDateOfBirth() {
          ...
          const formattedDate = formatDate(birthdayInput.value);
        ...
        function searchTable() {
          ...
          var tableRows = document.querySelectorAll(".member-row");

          // Loop through each row and hide/unhide them based on search value
          tableRows.forEach(function (row) {
            var username = row.querySelector("#member-uname").textContent.toLowerCase();
            var fullname = row.querySelector("#member-name").textContent.toLowerCase();
            if (
