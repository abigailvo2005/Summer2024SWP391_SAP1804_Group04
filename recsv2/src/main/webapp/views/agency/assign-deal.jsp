                    ...
                    <div class="row">
                      <div class="col-lg-8 col-9">
                        ...
                        <p class="text-sm mb-0">
                          ...
                          <span class="font-weight-bold ms-1">${dealList.size()} request(s)</span>
                          in total
                        </p>
                      </div>
                            ...
                            <c:forEach items="${dealList}" var="deal">
                              <tr class="deal-row">
                                <td class="align-middle text-center text-sm">
                                  <div class="d-flex px-2 py-1 justify-content-center">
                                    <div class="d-flex flex-column justify-content-center">
                                      <p id="deal-id" class="mb-0 text-sm fw-bold text-dark">
                                ...
                                <td class="align-middle">
                                  <div class="d-flex px-2 py-1 justify-content-center">
                                    <p id="deal-createDate" class="mb-0 text-sm fw-bold text-dark">
                                      ${deal.createDate}
                                    </p>
                                  </div>
                                </td>
                      ...
                      <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                          <input id="form-description" name="description" type="text"
                            class="form-control form-create-control" rows="5" disabled />
                        </div>
                      </div>
                      <div class="mb-3 row">
