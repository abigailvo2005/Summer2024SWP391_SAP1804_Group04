                ...
                <div class="card-body px-0 pb-2">
                  <div class="table-responsive">
                    <table class="table align-items-center mb-0">
                      ...
                      <tbody>
                        <c:forEach items="${dealList}" var="prop">
                          <tr class="deal-row">
                              ...
                              >
                                ...
                                >
                                  <p
                                    ...
                                    class="mb-0 text-sm fw-bold text-dark"
                                  >
                                    ${deal.realEstateInfo.realEstateType}
                                  </p>
                                </div>
                              </div>
                            </td>
                            ...
                            <td class="align-middle">
                              ...
                              >
                                ...
                                >
                                  <a
                                    class="show-detail"
                                    onclick="viewDetailProperty('${deal.realEstateId}', 'prop')"
        ...
        $.ajax({
          ...
          success: function (data) {
            ...
            if (data.realEstateType == 'land') {
              ...
              $("#popup-land-pw").text("sample-pdf-link");
              ...
              $("#popup-house-pw").text("sample-zip-link");
