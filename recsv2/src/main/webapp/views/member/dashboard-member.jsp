                  ...
                  <div class="col-lg-8 col-9">
                    ...
                    <p class="text-sm mb-0">
                      ...
                      <span class="font-weight-bold ms-1"
                        >${dealList.size()} deal(s) were assigned</span
                      >
                      in total
                    </p>
                  </div>
                            ...
                            <td class="align-middle">
                              ...
                              >
                                ...
                                >
                                  <a
                                    class="show-detail"
                                    onclick="viewDetailProperty('${deal.dealId}', 'deal')"
                ...
                <div class="row">
                  <div class="col-lg-8 col-9">
                    ...
                    <p class="text-sm mb-0">
                      <i class="fa-solid fa-house-user"></i>
                      <span class="font-weight-bold ms-1"
                        >${buyerRequestList.size()} request(s) were
                        submitted</span
                      >
                      in total
                    </p>
                            ...
                            <td class="align-middle">
                              ...
                              >
                                ...
                                >
                                  <a
                                    class="show-detail"
                                    onclick="viewDetailProperty('${req.requestId}', 'req')"
                                    ><i class="fa-solid fa-eye"></i
                                  ></a>
                                </div>
                              </div>
            ...
            <div class="card h-100">
              <div class="card-body p-3">
                <ul class="list-group">
                  ...
                  <!-- Seller Contact Info if Buyer is successfully accepted -->
                  <div id="seller-contact-info" class="row hidden">
                    <form id="seller-profile-form" class="px-3">
                      <div class="row d-flex justify-content-center mb-3">
                        <div class="col-12 text-center">
                          <strong>Property Owner Profile</strong>
                        </div>
                      </div>
                      <div class="row mb-3">
                        <div class="col-6">
                          <label id="seller-name" class="form-label"></label>
                        </div>
                        <div class="col-6">
                          <label id="seller-company" class="form-label"></label>
                        </div>
                      </div>

                      <div class="row mb-3">
                        <div class="col-6">
                          <label id="seller-phone" class="form-label"></label>
                        </div>
                        <div class="col-6">
                          <label id="seller-email" class="form-label"></label>
                        </div>
                      </div>

                      <div class="row mb-3">
                        <div class="col-6">
                          <label id="seller-gender" class="form-label"></label>
                        </div>
                        <div class="col-6">
                          <label
                            id="seller-birthday"
                      ...
                      <div class="mb-1 mt-2 row justify-content-center">
        ...
        if (type == "deal") {
          ...
          $.ajax({
            ...
            success: function (data) {
              ...
              $("#popup-status").text(data.status);
              $("#popup-desc").html(
                data.realEstateDTO.description.replace(/\r\n/g, "<br>")
              );
