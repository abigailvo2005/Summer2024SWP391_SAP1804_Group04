              ...
              <div class="col-12 col-xl-6 mt-sm-4">
                <div class="card h-100">
                  ...
                  <div class="card-body p-3">
                    <p class="text-sm">
                      As a member, you are an individual agent who work with the assigned agencies. Your main
                      responsibility is to find buyers for the listed properties and facilitate the exchange of contact
                      information between sellers and interested buyers.
                    </p>
                    <ul class="list-group">
                    ...
                    <ul class="list-group">
                      ...
                      <div id="phoneModal" class="profileUpdate">
                        <div class="update-content">
                          ...
                          <form action="${pageContext.request.contextPath}/member/phone/update" method="post"
                            id="phoneForm">
                      ...
                      <div id="passwordModal" class="profileUpdate">
                        <div class="update-content">
                          ...
                          <form action="${pageContext.request.contextPath}/member/password/update" method="post"
                            id="passwordForm">
                            <div>
