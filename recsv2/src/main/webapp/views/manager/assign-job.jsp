                    ...
                    <div class="row">
                      <div class="col-lg-8 col-9">
                        ...
                        <p class="text-sm mb-0">
                          ...
                          <span class="font-weight-bold ms-1">${reqList.size()} request(s)</span>
                          in total
                        </p>
                      </div>
                            ...
                            <c:forEach items="${reqList}" var="req">
                              <tr class="req-row">
                                <td class="align-middle text-center text-sm">
                                  <div class="d-flex px-2 py-1 justify-content-center">
                                    <div class="d-flex flex-column justify-content-center">
                                      <p id="req-id" class="mb-0 text-sm fw-bold text-dark">
                                ...
                                <td class="align-middle">
                                  <div class="d-flex px-2 py-1 justify-content-center">
                                    <p id="req-createDate" class="mb-0 text-sm fw-bold text-dark">
                                      ${req.createDate}
                                    </p>
                                  </div>
                                </td>
                                ...
                                <td class="align-middle">
                                  <div class="d-flex px-2 py-1 justify-content-center">
                                    <div class="d-flex flex-column justify-content-center">
                                      <a class="show-detail" onclick="viewDetail('${req.realEstateId}')"><i
            ...
            <div class="row">
              <div class="col-12 col-xl-11 mx-auto">
                <div class="card z-index-0">
                  ...
                  <div class="card-body">
                    <form id="form-assign-job" role="form text-left" name="assign-job-form"
                      action="${pageContext.request.contextPath}/manager/assign-job" method="post">
                      ...
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-6">
                          <select class="form-control form-create-control" onchange="chooseStaff(this.value)">
                        ...
                        <div class="col-sm-4">
                          <input id="form-chosen-staff" type="hidden" name="staffId"
                        ...
                        <div class="col-12 mt-1">
                          <div class="h-100 container-fluid mt-0">
                            <div class="row justify-content-center">
                              <div class="col-auto">
                                <button title="Validate Successfully. Added as Listing" type="button"
                                  onclick="showFormAssignJob()" class="btn btn-dark w-100 my-2 mb-2 btn-validation">
                                  Assign To Staff
                                </button>
                              </div>
                            </div>
