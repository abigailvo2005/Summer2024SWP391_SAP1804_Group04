                        ...
                        <div class="row gx-4">
                            <div class="col-auto">
                                <div class="avatar avatar-xl position-relative">
                                    <img src="${account.gender == 0 ? './../../template/assets/img/male-pfp.png' : './../../template/assets/img/female-pfp.png'}"
                                    ...
                                    <div class="card-body p-3">
                                        ...
                                        <ul class="list-group">
                                            ...
                                            <li class="list-group-item border-0 ps-0 text-sm">
                                                <strong class="text-dark">Gender:</strong> &nbsp; ${account.gender == 0
                                                ? 'Male' : 'Female'}
                                            </li>
                                            <li class="list-group-item border-0 ps-0 text-sm">
                                        ...
                                        <ul class="list-group">
                                            ...
                                            <li class="list-group-item border-0 d-flex align-items-center px-0 mb-2">
                                                ...
                                                <div class="pe-1 ps-0 mb-0 ms-auto">
                                                    <a class="btn btn-link pe-1 ps-1 mb-0 ms-auto" href="javascript:;"
                                                        id="changePhone">Change</a>
                                                </div>
                                            </li>
                                            ...
                                            <div id="phoneModal" class="profileUpdate">
                                                <div class="update-content">
                                                    ...
                                                    <form id="phoneForm">
                                                        ...
                                                        <button type="submit" id="updatePhone"
                                                            class="btn btn-dark my-2 mb-2">Update</button>
                                                        <button type="button" class="btn btn-dark my-2 mb-2"
                                                            id="cancelPhone">Cancel</button>
                                                    </form>
                                                </div>
                                            </div>
                                                    ...
                                                    <form id="passwordForm">
                                                        <div>
                                                            ...
                                                            <div class="password-container">
                                                                ...
                                                                <button type="button" class="toggle-password"
                                                                    data-toggle="#oldPassword">Show</button>
                                                            </div>
                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="password-container">
                                                                ...
                                                                <button type="button" class="toggle-password"
                                                                    data-toggle="#newPassword">Show</button>
                                                        ...
                                                        <div class="modal-buttons">
                                                            <button type="submit" id="updatePassword"
                                                                class="btn btn-dark my-2 mb-2">Update</button>
                                                            <button type="button" class="btn btn-dark my-2 mb-2"
                                                                id="cancelPassword">Cancel</button>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
