              ...
              <div class="col-12 col-xl-6 mt-sm-4">
                <div class="card h-100">
                  ...
                  <div class="card-body p-3">
                    <p class="text-sm">
                      As a manager, you are responsibled for receiving property
                      information from sellers and managing the staff's validation
                      process. You will review the submitted paperwork and
                      documentation to ensure the legal compliance of the
                      properties before they can be listed.
                    </p>
                    <ul class="list-group">
                    ...
                    <ul class="list-group">
                      ...
                      <li class="list-group-item border-0 d-flex align-items-center px-0 mb-2">
                        ...
                        <div class="pe-1 ps-0 mb-0 ms-auto">
                          <a class="btn btn-link pe-1 ps-1 mb-0 ms-auto" href="javascript:;" id="changePhone">Change</a>
                        </div>
                      </li>
                      ...
                      <div id="phoneModal" class="profileUpdate">
                        <div class="update-content">
                          ...
                          <form action="${pageContext.request.contextPath}/manager/phone/update" method="post"
                            id="phoneForm">
                      ...
                      <li class="list-group-item border-0 d-flex align-items-center px-0 mb-2">
                        ...
                        <div class="pe-1 ps-0 mb-0 ms-auto">
                          <div class="d-flex">
                            <a id="changePassword" class="btn btn-link pe-1 ps-1 mb-0 ms-auto"
                      ...
                      <div id="passwordModal" class="profileUpdate">
                        <div class="update-content">
                          ...
                          <form action="${pageContext.request.contextPath}/manager/password/update" 
                                method="post"
                                id="passwordForm">
                            <div>
                              ...
                              <div class="password-container">
                                ...
                                <button type="button" class="toggle-password" data-toggle="#oldPassword">
                                  Show
                                </button>
                              </div>
