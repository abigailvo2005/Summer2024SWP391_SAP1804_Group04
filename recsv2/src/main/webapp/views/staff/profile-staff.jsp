              ...
              <div class="col-12 col-xl-6 mt-sm-4">
                <div class="card h-100">
                  ...
                  <div class="card-body p-3">
                    <p class="text-sm">
                      As a staff, you are responsible for validating the properties' paperwork and confirming the legal
                      status of the listings. You will work closely with the managers to ensure that only legally
                      compliant properties are approved for the platform.
                    </p>
                    <ul class="list-group">
                    ...
                    <ul class="list-group">
                      ...
                      <div id="phoneModal" class="profileUpdate">
                        <div class="update-content">
                          ...
                          <form action="${pageContext.request.contextPath}/staff/phone/update" method="post"
                            id="phoneForm">
                      ...
                      <div id="passwordModal" class="profileUpdate">
                        <div class="update-content">
                          ...
                          <form action="${pageContext.request.contextPath}/staff/password/update" method="post"
                            id="passwordForm">
                            <div>
