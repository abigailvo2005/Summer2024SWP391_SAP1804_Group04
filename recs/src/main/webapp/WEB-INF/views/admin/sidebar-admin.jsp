    ...
    <%@ include file="/common/taglib.jsp" %>
      ...
      <body class="g-sidenav-show bg-gray-100">
        ...
        <aside
          ...
          <!-- sidebar: menu section-->
          <div class="sidenav-header mt-0">
            <a class="navbar-brand m-0" href="${pageContext.request.contextPath}/dashboard-admin" target="_self">
              <img src="<c:url value='/template/assets/img/logos/logo-no-name.png'/>" class="navbar-brand-img h-100"
                alt="main_logo" />
            ...
            <ul class="navbar-nav">
              <li class="nav-item">
                <a class="nav-link ${currentPage == 'dashboard' ? 'active' : ''}"
                  ...
                  <div
                    class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    <i class="fa-solid fa-table-columns" style="
                    $ {
                      currentpage!='dashboard'? 'color: #30221b;' : '';
                    }
                  "></i>
              ...
              <li class="nav-item">
                <a class="nav-link ${currentPage == 'tracking' ? 'active' : ''}"
                  href="${pageContext.request.contextPath}/property-tracking">
                  <div
                    class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            "></div>
              <div class="card-body text-start p-3 w-100">
                <div class="docs-info">
                  ...
                  <a href="${pageContext.request.contextPath}/history-admin" target="_self"
                    class="btn btn-white btn-sm w-100 mb-0">History</a>
                </div>
              </div>
            </div>
            <a class="btn bg-gradient-primary mt-3 w-100"
              href="${pageContext.request.contextPath}/create-account">Create Account</a>
          </div>
        </aside>
        <!-- END SIDEBAR -->
