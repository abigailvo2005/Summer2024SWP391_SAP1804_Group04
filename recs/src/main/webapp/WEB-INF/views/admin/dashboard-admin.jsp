  ...
  <%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@ include file="/common/taglib.jsp" %>
      ...
      <head>
        ...
        <!-- Link CSS -->
        <link id="pagestyle" href="<c:url value='/template/assets/css/soft-ui-dashboard.css?v=1.0.7' />"
          rel="stylesheet" />

        <!--Web's favicon-->
        <link rel="icon" type="image/png" href="<c:url value='/template/assets/img/logos/logo-no-name.png' />" />
      ...
      <body class="g-sidenav-show bg-gray-100" onload="makeTableScroll();">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td class="align-middle">
                              <div class="d-flex px-2 py-1 justify-content-center">
                                <div class="d-flex flex-column justify-content-center">
                                  <a class="show-detail" onclick="viewDetailRegisterRequest()"><i
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td class="align-middle">
                                <div class="d-flex px-2 py-1 justify-content-center">
                                  <div class="d-flex flex-column justify-content-center">
                                    <a onclick="viewDetailUser()" class="show-detail"><i
                                        class="fa-solid fa-eye"></i></a>
                                  </div>
                                </div>
                              </td>
        ...
        <div id="popup-register-request" class="popup-container hidden z-index-3">
          <div class="popup-content container-fluid">
            ...
            <div class="popup-header row mx-1">
              <div class="col-11">
                <h4 id="registered-name" class="card-header font-weight-bolder mb-0">
                  <!-- full name -->
                  Hoàng Việt Hùng
                </h4>
              </div>
            ...
            <div class="row">
                        ...
                        <div class="row">
                          <li class="list-group-item border-0 ps-0 col-6 text-sm">
                            ...
                            <img class="id-card card-img mt-2"
                              src="<c:url value='/template/assets/img/id-front-demo.jpeg'/>" alt="id-front" />
                          </li>
                          <li class="list-group-item border-0 ps-0 col-6 text-sm">
                            <strong class="text-dark">ID Card (Back):</strong>
                            &nbsp;
                            <img class="id-card card-img mt-2"
                              src="<c:url value='/template/assets/img/id-back-demo.jpeg'/>" alt="id-back" />
                          </li>
                        </div>
                      </div>
                    </ul>
              ...
              <div class="col-12 mt-1">
                <div class="h-100 container-fluid mt-0">
                  <div class="row justify-content-center">
                    <div class="col-auto">
                      <button type="button" onclick="adminResponse()" class="btn btn-success w-100 my-2 mb-2">
                        Approve
                      </button>
                    </div>

                    <div class="col-auto">
                      <button type="button" onclick="adminResponse()" class="btn btn-danger w-100 my-2 mb-2">
                        Decline
                      </button>
                    </div>
                  </div>
